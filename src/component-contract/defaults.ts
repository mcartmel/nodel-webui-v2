...
export const attributeDefaultMetadata: Record<string, AttributeDefaultMetadata> = {
  ...
  'nodel-control-grid.fill': { defaultValue: 'false' },
  ...
  'nodel-readout.ring-layout': { defaultValue: 'compact' },
  'nodel-readout.notch-position': { defaultValue: 'bottom' },
  'nodel-readout.notch-depth': { defaultValue: '15.4167%' },
  ...
  'nodel-shortcut.ctrl': { defaultValue: 'false' },
  'nodel-shortcut.alt': { defaultValue: 'false' },
  'nodel-shortcut.shift': { defaultValue: 'false' },
  'nodel-shortcut.meta': { defaultValue: 'false' },
  'nodel-shortcut.arg-type': { defaultValue: 'string' },
  'nodel-shortcut.disabled': { defaultValue: 'false' },
