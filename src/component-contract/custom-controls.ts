...
export const customControlElements: NodelElementDefinition[] = [
  ...
  },
  {
    ...
    attributes: [
      ...
      { name: 'ring-layout', description: 'Ring layout. Edge is only applied to ring visuals; other visuals remain unchanged.', values: ['compact', 'edge'], defaultValue: 'compact' },
      { name: 'notch-position', description: 'Edge-ring straight-mask position. Used only with ring-layout="edge".', values: ['bottom', 'left', 'top', 'right'], defaultValue: 'bottom' },
      { name: 'notch-depth', description: 'Edge-ring mask depth as a percentage of the full square design side. Valid percentages clamp to 0%..50%; malformed values use 15.4167%. Used only with ring-layout="edge".', valueType: 'string', syntax: 'percentage text' },
